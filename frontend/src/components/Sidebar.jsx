...
function Sidebar({ user, onLogout }) {
  ...
  const menuItems = [
    ...
    { path: '/soil-scanner', icon: Scan, label: t('soilScanner'), color: 'text-amber-600' },
    { path: '/climate-map', icon: Map, label: t('climateMap'), color: 'text-teal-600' },
    { path: '/market-predictor', icon: BarChart3, label: t('marketPredictor'), color: 'text-purple-600' },
